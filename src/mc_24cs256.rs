...
pub async fn write_byte(
    ...
    i2c.blocking_write(
        I2C_ADDRESS_EEPROM,
        &[address_bytes[0], address_bytes[1], data],
    )?;
...
pub async fn write_data_record(
    i2c: &mut I2c<'_, Blocking, Master>,
    address: u16,
    record: [u8; 12],
    crc: u32,
...
pub async fn read_32_bytes(
    i2c: &mut I2c<'_, Blocking, Master>,
    half_page: u16,
) -> Result<[u8; 32], i2c::Error> {
